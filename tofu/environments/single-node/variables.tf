...
variable "name" {
  description = "Unique name prefix for all resources (e.g. azimuth-singlenode)"
  type        = string
  default     = "azimuth"
}
...
variable "talos_image_id" {
  description = "Glance image ID of the Talos QCOW2 image. Generate at https://factory.talos.dev/"
  type        = string
}
