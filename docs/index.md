...
Alternatively, an experimental [kubernetes only mode](./configuration/17-kubernetes-only.md) is currently in development which can deploy Azimuth onto any Kubernetes cluster (with limited functionality).
